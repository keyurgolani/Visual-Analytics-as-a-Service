...
// "colorize" the widget name
    $.widget("flowchart.flowchart", {
        ...
        options: {
            ...
            onOperatorSelect2: function (operatorId) {
                return true;
            },
        ...
        _initEvents: function () {
            ...
            this.objs.layers.operators.on('dblclick', '.flowchart-operator', function (e) {
                if ($(e.target).closest('.flowchart-operator-connector').length == 0) {
                    self.selectOperator2($(this).data('operator_id'));
                }
            });
        ...
        selectOperator2: function (operatorId) {
            if (!this.callbackEvent('operatorSelect2', [operatorId])) {
                return;
            }
            this.unselectLink();
            this._removeSelectedClassOperators();
